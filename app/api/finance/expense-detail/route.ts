...
import { getPropertyExpenseBreakdown, isVrPlatformConfigured } from "@/lib/vrplatform";
...
export async function GET(request: Request) {
  ...
  try {
    ...
    const breakdown = await getPropertyExpenseBreakdown(
      {
    ...
    return NextResponse.json(
      { reference: property.reference, ...breakdown },
