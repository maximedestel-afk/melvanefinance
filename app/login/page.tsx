    ...
    <div className="flex min-h-screen items-center justify-center px-4 py-12">
      <div className="w-full max-w-[380px]">
        <div className="text-center">
          ...
          <h1 className="mt-4 text-[28px] font-semibold tracking-tight text-[#1d1d1f]">Analyse financière</h1>
          <p className="mt-1.5 text-[15px] text-[#6e6e73]">
            Connectez-vous avec votre compte M.G.B pour accéder à l&apos;analyse financière du parc.
          </p>
        </div>
